...
def webservice_converter(request):
    if request.method == 'POST':
        ...
        if original_video and format_to:
            try:
                ...
                return redirect('webservice_result_page')
    ...
    return render(request, 'webservice_converter/converter.html')




def webservice_result_page(request):
    download_link = request.session.pop('download_link', None)

    return render(request, 'webservice_converter/result_page.html', {'download_link': download_link})