...
def device_converter(request):
    if request.method == 'POST':
        ...
        if original_video and format_to:
            try:
                ...
                return redirect('device_result_page')
    ...
    return render(request, 'device_converter/converter.html')




def device_result_page(request):
    download_link = request.session.pop('download_link', None)

    return render(request, 'device_converter/result_page.html', {'download_link': download_link})